...
export default function MovieCard({ movie }: MovieCardProps) {
  ...
  return (
    <div
      ...
      className="relative rounded-xl shadow-lg overflow-hidden cursor-pointer w-44 transistion-tranform duration-500 hover:scale-105"
    ...
    >
      ...
      {isHovered && (
        ...
        to-transparent backdrop-blur-md flex flex-col justify-center text-white p-4"
        >
